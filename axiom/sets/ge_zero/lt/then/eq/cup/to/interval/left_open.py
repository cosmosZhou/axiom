...
def prove(Eq):
    ...
    Eq << sets.ge_zero.then.eq.cup.to.interval.left_open.apply(Eq[-1], k)
    ...
    Eq << sets.ge_zero.then.eq.cup.to.interval.left_open.apply(Eq.b_is_nonnegative, k)
    ...
    Eq << algebra.ge.then.eq.min.apply(Eq.b_is_nonnegative)
