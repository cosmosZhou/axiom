...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(sets.el_interval.is_finite.then.is_real.sum, simplify=None)
    ...
    Eq << Eq[-1].this.lhs.apply(sets.el_interval.is_finite.then.is_real.sum.negative, simplify=None)
