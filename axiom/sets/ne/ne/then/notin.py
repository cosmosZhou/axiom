...
def prove(Eq):
    ...
    Eq << sets.ne.then.notin.apply(Eq[0], simplify=False)
    Eq << sets.ne.then.notin.apply(Eq[1], simplify=False)

    Eq << sets.notin.notin.then.notin.union.apply(Eq[-1], Eq[-2], simplify=False)
