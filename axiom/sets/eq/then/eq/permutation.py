...
def prove(Eq):
    ...
    Eq << sets.cup_subset.of.all_subset.apply(Eq.subset)

    Eq << Eq[-1].apply(sets.el_cup.of.any_el)
    ...
    Eq.definition = Eq[-1].apply(sets.el_cup.of.any_el)

    Eq << discrete.eq.then.et.index.apply(Eq[0], _j)
