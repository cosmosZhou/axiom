...
def prove(Eq):
    ...
    Eq << Eq[-1].this.args[-1].apply(algebra.eq.eq.imply.eq.subs, simplify=None)

    Eq << Eq[-1].this.args[-2].apply(algebra.eq.eq.imply.eq.subs, simplify=None)

    Eq << Eq[-1].this.args[0].apply(algebra.eq.eq.imply.eq.subs)
