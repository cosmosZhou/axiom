...
def prove(Eq):
    ...
    Eq << Eq[-1].this.expr.apply(sets.el.of.subset, simplify=False)

    Eq << sets.all_subset.of.subset.lhs.apply(Eq[-1])

    Eq << algebra.all.then.ou.subs.apply(Eq.all_contains, x, y)
