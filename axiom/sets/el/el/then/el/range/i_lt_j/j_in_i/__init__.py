...
def prove(Eq):
    ...
    Eq << sets.el.then.el.sub.apply(Eq[1], d)

    Eq << sets.el.of.el.sub.apply(Eq[2], d)

    Eq <<= sets.el_range.of.et.apply(Eq[-1]), sets.el_range.of.et.apply(Eq[3])

    Eq <<= sets.el_range.then.et.apply(Eq[0]), sets.el_range.then.et.apply(Eq[4])

    Eq << algebra.ge.then.gt.relax.apply(Eq[-2])

    Eq << algebra.gt.ge.then.gt.trans.apply(Eq[-1], Eq[6])
