...
def prove(Eq):
    ...
    Eq <<= Eq[-3].this.rhs.args[:2].apply(algebra.lt.gt.then.ge.relax), Eq[-2].this.rhs.args[:2].apply(algebra.le.le.then.le.trans),  Eq[-1].this.lhs.apply(algebra.et.then.ou)
