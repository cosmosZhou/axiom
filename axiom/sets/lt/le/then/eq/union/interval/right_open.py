...
def prove(Eq):
    ...
    Eq <<= Eq[-3].this.rhs.args[::2].apply(algebra.le.lt.then.le.relax), Eq[-2].this.rhs.args[::2].apply(algebra.lt.ge.then.gt.trans),  Eq[-1].this.lhs.apply(algebra.et.then.ou)
