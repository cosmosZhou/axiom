...
def prove(Eq):
    ...
    Eq << stats.eq_conditioned.imply.eq.conditioned.getitem.apply(Eq[0])
    ...
    Eq.eq_at = stats.eq_conditioned.imply.eq.conditioned.getitem.apply(Eq[-1], 0)
    ...
    Eq.eq_st = stats.eq_conditioned.imply.eq.conditioned.getitem.apply(Eq[-1], 0)
