...
def prove(Eq):
    ...
    Eq << stats.eq_conditioned.imply.eq.conditioned.getitem.apply(Eq[0], 0)

    Eq << stats.eq_conditioned.imply.eq.conditioned.oo.independence_assumption.apply(Eq[-1])
    ...
    Eq << stats.ne_zero.eq_conditioned.eq_conditioned.imply.eq.conditioned.joint.apply(Eq[-1], Eq[-2], Eq[-4])
    ...
    Eq << stats.ne_zero.eq_conditioned.imply.eq.conditioned.joint.apply(Eq[-1], Eq[-4])
