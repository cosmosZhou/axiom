...
def prove(Eq):
    ...
    Eq << Eq[-1].this().expr.lhs.rhs.args[1].apply(algebra.eq.imply.et.eq.split)

    Eq << stats.eq_conditioned.imply.eq.single_condition_w.apply(Eq[-1], wrt=Eq[-1].lhs.rhs.args[-1].lhs)
