...
def prove(Eq):
    ...
    Eq << stats.eq_conditioned.imply.eq_conditioned.oo.independence_assumption.apply(Eq[0])
    ...
    Eq << stats.ne_zero.eq_conditioned.imply.eq.conditioned.joint.apply(Eq[-1], Eq[2])
