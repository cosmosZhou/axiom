...
def prove(Eq):
    ...
    Eq << stats.eq_conditioned.then.eq.conditioned.getitem.apply(Eq[0])
    ...
    Eq.eq_at = stats.eq_conditioned.then.eq.conditioned.getitem.apply(Eq[-1], 0)
    ...
    Eq.eq_st = stats.eq_conditioned.then.eq.conditioned.getitem.apply(Eq[-1], 0)
    ...
    Eq << stats.ne_zero.then.ne_zero.delete.apply(Eq[-1], slice(2, None))

    Eq << stats.ne_zero.eq_conditioned.eq_conditioned.then.eq.conditioned.joint.apply(Eq[-1], Eq.eq_at, Eq.eq_st)
