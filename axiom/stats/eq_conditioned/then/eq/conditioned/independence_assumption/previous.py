...
def prove(Eq):
    ...
    Eq << stats.eq_conditioned.then.eq.conditioned.oo.independence_assumption.apply(Eq[0])

    Eq << stats.ne_zero.eq_conditioned.then.eq.conditioned.joint.apply(Eq[-2], Eq[-1])
