...
def prove(Eq):
    ...
    Eq << stats.ne_zero.gt.then.et.ne_zero.apply(Eq[0], Eq[2])

    Eq << stats.ne_zero.gt.then.et.ne_zero.apply(Eq[1], Eq[2])
    ...
    Eq << stats.ne_zero.ne_zero.then.ge.KL.pdf.apply(Eq[-4], Eq[-2], Eq[-1].lhs.arg.lhs)

    Eq << stats.gt.then.eq.prob.joint.apply(Eq[2], Eq[0].lhs)

    Eq << stats.gt.then.eq.prob.joint.apply(Eq[2], Eq[1].lhs)
