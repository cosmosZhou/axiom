...
def apply(ne_zero, r_expected_def):
    (((r, t), (((s, S[t]), S[s[t].var]), ((a, S[t - 1]), S[a[t - 1].var]), S[s[t - 1].as_boolean()])), (S[r[t]],)), r_st = \
    r_expected_def.of(Equal[Expectation[Conditioned[Indexed, Equal[Indexed] & Equal[Indexed]]]])
