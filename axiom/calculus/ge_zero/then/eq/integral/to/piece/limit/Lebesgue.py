...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.rhs.apply(calculus.ge_zero.then.eq.integral.to.mul.limit.Lebesgue, Eq[-3].find(Integral)), Eq[-1].this.rhs.apply(calculus.ge_zero.then.eq.integral.to.mul.limit.Lebesgue, Eq[-4].find(Integral))
