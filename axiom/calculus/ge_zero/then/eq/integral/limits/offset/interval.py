...
def prove(Eq):
    ...
    Eq << calculus.ge_zero.then.eq.integral.to.mul.limit.Lebesgue.apply(Eq[0], Eq[1].lhs)

    Eq << calculus.ge_zero.then.eq.integral.to.mul.limit.Lebesgue.apply(Eq[0], Eq[1].rhs)
