...
def prove(Eq):
    ...
    Eq << algebra.cond.imply.all.restrict.apply(Eq[0], *Eq[-1].find(Maxima).limits)

    Eq << algebra.all_ge.imply.maxima_ge.apply(Eq[-1])

    Eq << algebra.cond.imply.all.restrict.apply(Eq[-1], *limits)
