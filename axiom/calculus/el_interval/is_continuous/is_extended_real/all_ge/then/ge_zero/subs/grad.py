...
def prove(Eq):
    ...
    Eq << Eq[-2].this.expr.apply(sets.el.then.el.neg, simplify=None)

    Eq << calculus.el_interval.is_continuous.is_extended_real.all_le.then.le_zero.subs.grad.apply(Eq[0], Eq[-4], Eq[-1], Eq[-2])
