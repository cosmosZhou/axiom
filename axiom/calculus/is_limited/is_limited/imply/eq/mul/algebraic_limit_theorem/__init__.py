...
def prove(Eq):
    ...
    Eq << Eq[-1].this.rhs.args[1].apply(sets.el.imply.any.eq, var='B', simplify=None)
    ...
    Eq << Eq[-1].this.rhs.apply(calculus.is_limited.is_limited.imply.eq.mul.nonzero.algebraic_limit_theorem)
