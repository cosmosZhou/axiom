...
def prove(Eq):
    ...
    Eq.gt_zero, Eq.le_zero = algebra.cond.of.et.infer.split.apply(Eq[-1], cond=λ > 0)

    Eq.lt_zero, Eq.is_zero = algebra.infer.of.et.infer.split.apply(Eq.le_zero, cond=λ < 0)
    ...
    Eq << algebra.cond.infer.of.et.infer.et.apply(Eq[1], Eq[-1])

    Eq << Eq[-1].this.lhs.apply(calculus.el_interval.is_finite.then.is_zero.limit)
    ...
    Eq << Eq[-1].this.lhs.apply(calculus.el_interval.is_finite.then.is_zero.limit.negative)
