...
def prove(Eq):
    ...
    Eq << Eq[0].this.find(And).apply(algebra.le.le.imply.le.transit, ret=1)
    ...
    Eq << calculus.le.any_all_ge.imply.eq.limit.to.inf.monotone_convergence_theorem.apply(Eq[-2], Eq[-1])
