...
def prove(Eq):
    ...
    Eq << Eq[0].this.find(And).apply(algebra.ge.ge.then.ge.trans, ret=1)
    ...
    Eq << calculus.ge.any_all_le.then.eq.limit.to.sup.monotone_convergence_theorem.apply(Eq[-2], Eq[-1])
