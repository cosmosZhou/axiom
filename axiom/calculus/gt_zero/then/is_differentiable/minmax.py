...
def prove(Eq):
    ...
    Eq << calculus.gt_zero.then.is_differentiable.within.apply(Eq[0], x0, x1, x=Eq[1].variable)

    Eq << calculus.gt_zero.then.is_differentiable.within.apply(Eq[0], x1, x0, x=Eq[1].variable)
