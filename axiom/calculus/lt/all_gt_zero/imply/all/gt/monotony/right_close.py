...
def prove(Eq):
    ...
    Eq << Eq[-1].this.rhs.apply(calculus.lt.is_continuous.is_differentiable.imply.any.eq.mean_value_theorem.Lagrange)

    Eq << Eq[-1].this.rhs.apply(algebra.any.imply.any.et.limits.cond, simplify=None)
    ...
    Eq << Eq[-1].this.rhs.apply(algebra.all.any.imply.any.et)
    ...
    Eq << Eq[-1].this.rhs.apply(algebra.any.imply.any.et.limits.unleash)
