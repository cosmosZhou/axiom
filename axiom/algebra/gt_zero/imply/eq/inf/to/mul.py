...
def prove(Eq):
    ...
    z = Symbol(real=True)
    Eq <<= algebra.inf_le.imply.all.any.lt.apply(Eq[-2], z), algebra.inf_ge.imply.all.ge.apply(Eq[-1])
    ...
    Eq << Eq[-2].this.rhs.apply(algebra.cond.any.imply.any.et, simplify=None)
