...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.lhs.apply(sets.gt_zero.el.then.eq.inf.st.quadratic, Eq[-2].find(Inf).expr, x), algebra.infer_ou.of.et.infer.apply(Eq[-1])
    ...
    Eq <<= Eq[-2].this.rhs.apply(algebra.gt_zero.ge_zero.lt.then.eq.inf_square.to.square), \
        Eq[-2].this.rhs.apply(algebra.gt_zero.ge_zero.lt.then.eq.min.to.square),\
        Eq[-1].this.rhs.apply(algebra.gt_zero.le_zero.lt.then.eq.inf_square.to.square),\
        Eq[-1].this.rhs.apply(algebra.gt_zero.le_zero.lt.then.eq.min.to.square)
