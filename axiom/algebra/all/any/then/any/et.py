...
def prove(Eq):
    ...
    Eq << algebra.any.of.any.et.limits.unleash.apply(Eq[-1])

    Eq.any = algebra.any.then.any.et.limits.unleash.apply(Eq[1], simplify=False)
    ...
    Eq << Eq.any.this.expr.args[2].apply(algebra.cond.infer.then.cond.trans, Eq[-1])
