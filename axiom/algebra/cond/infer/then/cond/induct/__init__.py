...
def prove(Eq):
    ...
    Eq << algebra.cond.then.eq.bool.apply(Eq[0])

    Eq.initial = algebra.eq.eq.then.eq.trans.apply(Eq[-2], Eq[-1])
    ...
    Eq << algebra.eq.infer.then.eq.induct.apply(Eq.initial, Eq.suffice, n=n)
