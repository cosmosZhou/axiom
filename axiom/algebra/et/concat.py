...
def prove(Eq):
    ...
    Eq <<= algebra.infer_et.of.infer.delete.apply(Eq[-2]), Eq[-1].this.rhs.args[0].apply(algebra.eq.then.et.eq.split, simplify=None)

    Eq << Eq[-1].this.lhs.apply(algebra.eq.eq.then.eq.concat, simplify=None)
