...
def prove(Eq):
    ...
    Eq <<= algebra.infer_et.given.infer.delete.apply(Eq[-2]), Eq[-1].this.rhs.args[0].apply(algebra.eq.imply.et.eq.split, simplify=None)

    Eq << Eq[-1].this.lhs.apply(algebra.eq.eq.imply.eq.concat, simplify=None)
