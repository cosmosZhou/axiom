...
def prove(Eq):
    ...
    Eq << Eq[1].apply(algebra.infer.then.ou)

    Eq.is_multiplication_zero = algebra.ou.then.is_zero.apply(Eq.or_statement)
    ...
    Eq << algebra.eq.eq.then.eq.subs.apply(Eq[-1].reversed, Eq[-5])
