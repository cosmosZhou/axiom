...
def prove(Eq):
    ...
    Eq <<= Eq[-4].this.expr.apply(algebra.any.imply.any.limits.negate), algebra.all.imply.all.limits.subs.negate.real.apply(Eq[-3], x, -x), algebra.inf_le.given.all_any_lt.apply(Eq[-2], z), algebra.inf_ge.given.all.ge.apply(Eq[-1])
