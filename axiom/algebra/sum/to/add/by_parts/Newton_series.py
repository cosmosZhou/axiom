...
def prove(Eq):
    ...
    Eq << Eq.abel.find(Sum[Tuple, Tuple]).this.apply(discrete.sum_binom.limits.swap.lower)

    Eq << Eq.abel.find(-Sum).find(Sum[Tuple, Tuple]).this.apply(discrete.sum_binom.limits.swap.lower)
