...
def prove(Eq):
    ...
    Eq <<= algebra.infer.imply.et.infer.apply(Eq[-2], None), algebra.infer.imply.et.infer.apply(Eq[-1].this.rhs.apply(algebra.poly_is_zero.imply.et.infer.ou.eq.cubic.one_leaded, x), None)
