...
def prove(Eq):
    ...
    Eq <<= Eq[0].cond.this.apply(algebra.poly_is_zero.given.et.eq.cubic.depressed, x, 1), Eq[0].cond.this.apply(algebra.poly_is_zero.given.et.eq.cubic.depressed, x, -2)
