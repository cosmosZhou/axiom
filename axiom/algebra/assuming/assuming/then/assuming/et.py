...
def prove(Eq):
    ...
    Eq << algebra.assuming.of.assuming.split.et.apply(Eq[-1])

    Eq << Eq[-2].this.rhs.apply(algebra.et.then.cond, index=0)

    Eq << Eq[-1].this.rhs.apply(algebra.et.then.cond, index=1)
