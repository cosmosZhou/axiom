...
def prove(Eq):
    ...
    Eq << algebra.le_zero.lt.lt.then.any.square_gt.apply(Eq[-2], Eq[-1], Eq[2])

    Eq << sets.ge_zero.then.subset.interval.lower.apply(Eq[0], m, left_open=True, right_open=True)
