...
def prove(Eq):
    ...
    Eq << Eq.is_zero.this.lhs.apply(algebra.et.then.cond, index=0)
    ...
    Eq << Eq.is_negative.this.lhs.apply(algebra.lt_zero.ge_zero.then.le_zero)

    Eq << algebra.infer.infer.then.infer.ou.apply(Eq.is_zero, Eq.is_negative)
