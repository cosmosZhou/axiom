...
def prove(Eq):
    ...
    Eq << algebra.eq.eq.then.eq.trans.apply(Eq.cossin, Eq[-1])

    Eq << algebra.eq.then.eq.lamda.apply(Eq[-1], (j, 0, d))
    ...
    Eq <<= algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq[-2])
    ...
    Eq << algebra.eq.eq.then.eq.trans.apply(Eq.coscos, Eq[-1])
    ...
    Eq.geometric_progression = algebra.eq.then.eq.geometric_progression.apply(Eq[-1], n=i)
    ...
    Eq <<= geometry.eq.then.eq.cos.apply(Eq[-1]), geometry.eq.then.eq.sin.apply(Eq[-1])
