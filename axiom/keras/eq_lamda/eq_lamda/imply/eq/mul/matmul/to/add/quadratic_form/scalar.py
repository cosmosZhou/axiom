...
def apply(eq_x, eq_a):
    ...
    from axiom.discrete.mul.matmul.to.add.quadratic_form import quadratic_form, reduced_sum
...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(discrete.mul.matmul.to.add.quadratic_form)
