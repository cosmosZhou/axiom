...
def prove(Eq):
    ...
    Eq << keras.ne_zero.eq.eq.eq.then.eq.crf.markov.apply(*Eq[:4], t=t)
    ...
    Eq << algebra.eq.cond.then.cond.subs.apply(Eq.eq_x.subs(t, i).reversed, Eq[-1])

    Eq << algebra.eq.cond.then.cond.subs.apply(Eq.eq_G.subs(t, i).reversed, Eq[-1])
