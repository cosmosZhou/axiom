...
def prove(Eq):
    ...
    *Eq[-3:], Eq.hypothesis = apply(
    ...
    Eq.recursion = keras.eq_conditioned.eq_expect.eq_expect.imply.eq.grad.policy_gradient.recursion.discrete.apply(*Eq[:3])
    ...
    Eq << Eq[-1].this.find(Product * Sum[Mul[Probability]]).apply(algebra.mul.to.sum)
