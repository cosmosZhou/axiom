...
def prove(Eq):
    ...
    Eq << algebra.cond.imply.cond.domain_defined.apply(Eq.x_independence)
    ...
    Eq << stats.ne_zero.eq_conditioned.imply.eq.conditioned.joint.apply(Eq[-1], Eq[0])
    ...
    Eq << algebra.ou.imply.all.apply(Eq[-1])
