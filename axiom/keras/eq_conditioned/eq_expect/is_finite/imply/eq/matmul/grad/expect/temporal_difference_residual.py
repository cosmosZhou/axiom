...
def prove(Eq):
    ...
    *Eq[-3:], Eq.hypothesis = apply(
    ...
    Eq << keras.eq_conditioned.eq_expect.eq_expect.eq_sub.is_finite.imply.eq.matmul.grad.expect.A_Function.apply(Eq[0], Eq.Q_Function, Eq[1], Eq.A_Function, Eq[2])

    Eq << keras.eq_conditioned.eq_expect.eq_expect.eq_sub.imply.eq.expect.temporal_difference_residual.apply(Eq[0], Eq.Q_Function, Eq[1], Eq.A_Function).reversed
