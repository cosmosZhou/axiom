...
def prove(Eq):
    ...
    Eq.le = algebra.eq_max.eq_min.then.le.apply(Eq.beta, Eq.zeta)
    ...
    Eq <<= algebra.le.eq.then.eq.slice.apply(Eq.le, Eq[-2], step=d), algebra.le.eq.then.eq.slice.apply(Eq.le, Eq[-1], step=d)
    ...
    Eq << algebra.le.then.le.ceiling.apply(Eq.le / d)

    Eq <<= algebra.le.eq.then.eq.slice.apply(Eq[-1], Eq[-3]), algebra.le.eq.then.eq.slice.apply(Eq[-1], Eq[-2])

    Eq <<= algebra.eq.eq.then.eq.trans.apply(Eq.eq_K_dquote, Eq[-2]), algebra.eq.eq.then.eq.trans.apply(Eq.eq_V_dquote, Eq[-1])
