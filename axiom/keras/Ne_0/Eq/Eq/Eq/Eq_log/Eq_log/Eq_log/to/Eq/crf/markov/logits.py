...
def prove(Eq):
    ...
    Eq << Keras.Ne_0.Eq.Eq.Eq.to.Eq.crf.markov.apply(*Eq[:4], t=t)
    ...
    Eq << Algebra.Eq.Cond.to.Cond.subs.apply(Eq.eq_x.subs(t, i).reversed, Eq[-1])

    Eq << Algebra.Eq.Cond.to.Cond.subs.apply(Eq.eq_G.subs(t, i).reversed, Eq[-1])
