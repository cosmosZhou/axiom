...
def prove(Eq):
    ...
    Eq <<= Algebra.Eq.to.Eq.rsolve.apply(Eq[2]), Algebra.Eq.to.Eq.rsolve.apply(Eq[3])
    ...
    # http://localhost/axiom/?module=Keras.Dot_softmax.to.Lamda.sum.scaled_dot_product_attention
