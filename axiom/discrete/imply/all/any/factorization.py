...
def prove(Eq):
    ...
    Eq << discrete.imply.all.any.permutation.any.basic.apply(n + 1)
    ...
    Eq << algebra.all_any_eq.cond.imply.all.any.subs.apply(Eq.any_n, Eq[-1])
    ...
    Eq << algebra.cond.all_any.imply.all.any.et.apply(Eq[-1], Eq[-2])
