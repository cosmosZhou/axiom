...
def prove(Eq):
    ...
    Eq << algebra.all.of.all_et.conditionset.apply(Eq[-1], simplify=None)
    Eq << Eq[-1].this.expr.apply(algebra.et.of.any_et, simplify=None)
    ...
    Eq << algebra.all.any.then.any_et.apply(Eq.x_union_s0, Eq[-1].reversed, simplify=False)
    ...
    Eq << algebra.all.any.then.any_et.apply(Eq.x_union_s2, Eq.x_j_definition)
