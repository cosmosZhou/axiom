...
def prove(Eq):
    ...
    Eq.stirling2 = Eq[0].lhs.this.apply(discrete.stirling.to.card)

    Eq.stirling0 = Eq[0].rhs.args[1].this.apply(discrete.stirling.to.card)

    Eq.stirling1 = Eq[0].rhs.args[0].args[1].this.apply(discrete.stirling.to.card)
    ...
    Eq << discrete.condset.to.cup.stirling.mapping.s2_A.apply(n, k, s2)
    ...
    Eq << discrete.abs.cup.to.sum.stirling.nonoverlapping.A.apply(n, k, A)
