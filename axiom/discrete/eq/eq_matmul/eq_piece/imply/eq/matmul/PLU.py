...
def prove(Eq):
    ...
    Eq.back_subs1 = Eq.back_subs1.this.find(-Piecewise).apply(algebra.mul_piece.to.piece)
    ...
    Eq.back_subs2 = Eq.back_subs2.this.find(-Piecewise).apply(algebra.mul_piece.to.piece)
    ...
    Eq.back_subs3 = Eq.back_subs3.this.find(-Piecewise).apply(algebra.mul_piece.to.piece)
    ...
    Eq.back_subs4 = Eq.back_subs4.this.find(-Piecewise).apply(algebra.mul_piece.to.piece)
    ...
    Eq.back_subs5 = Eq.back_subs5.this.find(-Piecewise).apply(algebra.mul_piece.to.piece)
    ...
    Eq.back_subs6 = Eq.back_subs6.this.find(-Piecewise).apply(algebra.mul_piece.to.piece)
