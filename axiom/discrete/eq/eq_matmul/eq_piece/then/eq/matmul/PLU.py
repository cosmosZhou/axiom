...
def prove(Eq):
    ...
    Eq.back_subs0 = discrete.eq_matmul.then.eq.inverse.apply(Eq[-1], left=True)

    Eq.back_subs0 = algebra.eq.eq.then.eq.trans.apply(Eq[0], Eq.back_subs0)
    ...
    Eq.back_subs1 = discrete.eq_matmul.then.eq.inverse.apply(Eq[-1], left=True)

    Eq.back_subs1 = algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq.back_subs1)

    Eq.back_subs1 = discrete.eq_matmul.then.eq.inverse.apply(Eq.back_subs1, left=True)
    ...
    Eq.back_subs2 = discrete.eq_matmul.then.eq.inverse.apply(Eq[-1], left=True)

    Eq.back_subs2 = algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq.back_subs2)

    Eq.back_subs2 = discrete.eq_matmul.then.eq.inverse.apply(Eq.back_subs2, left=True)
    ...
    Eq.back_subs3 = discrete.eq_matmul.then.eq.inverse.apply(Eq[-1], left=True)

    Eq.back_subs3 = algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq.back_subs3)

    Eq.back_subs3 = discrete.eq_matmul.then.eq.inverse.apply(Eq.back_subs3, left=True)
    ...
    Eq.back_subs4 = discrete.eq_matmul.then.eq.inverse.apply(Eq[-1], left=True)

    Eq.back_subs4 = algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq.back_subs4)

    Eq.back_subs4 = discrete.eq_matmul.then.eq.inverse.apply(Eq.back_subs4, left=True)
    ...
    Eq.back_subs5 = discrete.eq_matmul.then.eq.inverse.apply(Eq[-1], left=True)

    Eq.back_subs5 = algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq.back_subs5)

    Eq.back_subs5 = discrete.eq_matmul.then.eq.inverse.apply(Eq.back_subs5, left=True)
    ...
    Eq.back_subs6 = algebra.eq.eq.then.eq.trans.apply(Eq[-4], Eq.back_subs6)

    Eq.back_subs6 = discrete.eq_matmul.then.eq.inverse.apply(Eq.back_subs6, left=True)
