...
def prove(Eq):
    ...
    Eq << discrete.ne_zero.then.ne_zero.inverse.apply(Eq[0])

    Eq << discrete.ne_zero.then.ne_zero.inverse.apply(Eq[1])

    Eq << discrete.ne_zero.then.ne_zero.inverse.apply(Eq[2])
