...
class Adminer {
	...
	*/
	...
	/** Get host name displayed in breadcrumbs
	* @param string
	...
	*/
	function head() {
		?>
<link rel="stylesheet" type="text/css" href="./static/jush/jush.css">
<?php
		return true;
	}
	...
	*/
	function login($login, $password) {
		if ($password == "") {
			return 'Access to a database without a password is not supported.';
		}
		return true;
	}
	...
	*/
	function dumpFilename($identifier) {
		return friendly_url($identifier != "" ? $identifier : (HOST != "" ? HOST : "localhost"));
	}
	...
	function navigation($missing) {
		...
		if ($missing == "auth") {
			...
			foreach ((array) $_SESSION["pwds"] as $vendor => $servers) {
			    foreach ($servers as $host => $usernames) {
			...
			echo script_src("./static/jush/modules/jush.js");
			echo script_src("./static/jush/modules/jush-textarea.js");
			echo script_src("./static/jush/modules/jush-txt.js");
			echo script_src("./static/jush/modules/jush-js.js");
			if (support("sql")) {
				echo script_src("./static/jush/modules/jush-$jush.js");
				?>
