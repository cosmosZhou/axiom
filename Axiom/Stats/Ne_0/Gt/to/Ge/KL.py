...
def prove(Eq):
    ...
    Eq << Stats.Ne_0.Gt.to.And.Ne_0.apply(Eq[0], Eq[2])

    Eq << Stats.Ne_0.Gt.to.And.Ne_0.apply(Eq[1], Eq[2])
    ...
    Eq << Stats.Ne_0.Ne_0.to.Ge.KL.pdf.apply(Eq[-4], Eq[-2], Eq[-1].lhs.arg.lhs)

    Eq << Stats.Gt.to.Eq.Prob.joint.apply(Eq[2], Eq[0].lhs)

    Eq << Stats.Gt.to.Eq.Prob.joint.apply(Eq[2], Eq[1].lhs)
