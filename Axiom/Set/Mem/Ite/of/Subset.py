...
def prove(Eq):
    ...
    Eq << Set.Mem.of.Subset.apply(Eq[0])

    Eq.bool_fx = Set.Eq.Bool.Mem.of.Mem.apply(Eq[-1])

    Eq << Set.Mem.of.Subset.apply(Eq[0], 1)

    Eq.bool_gx = Set.Eq.Bool.Mem.of.Mem.apply(Eq[-1])

    Eq << Set.Mem.of.Subset.apply(Eq[0], 2)

    Eq.bool_hx = Set.Eq.Bool.Mem.of.Mem.apply(Eq[-1])
    ...
    Eq << Set.MemIte__Ite.of.And.ou.OrAndS.apply(Eq[-1], wrt=S)
