...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.lhs.apply(Set.All_Mem.of.Mem_Cap), Eq[-1].this.lhs.apply(Set.All_Mem.of.Mem_Cap)

    Eq <<= Eq[-2].this.rhs.apply(Set.Mem_Cap.given.All_Mem), Eq[-1].this.rhs.apply(Set.Mem_Cap.given.All_Mem)

    Eq <<= Eq[-2].this.lhs.apply(Algebra.All.of.All.limits.subs.offset, d)

    Eq <<= Eq[-1].this.lhs.apply(Algebra.All.of.All.limits.subs.offset, -d)
