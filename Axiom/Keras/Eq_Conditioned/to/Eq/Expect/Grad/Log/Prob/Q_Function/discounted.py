...
def prove(Eq):
    ...
    Eq << Eq[-1].this.find(Expectation[Conditioned[MatMul]]).apply(Stats.Expect.eq.Dot)

    Eq << Stats.Eq_Conditioned.to.Eq.Conditioned.independence_assumption.bidirectional.forget_histories.apply(Eq[0])#.subs(t, t + 1)
