...
def prove(Eq):
    ...
    *Eq[-3:], Eq.hypothesis = apply(
    ...
    Eq << Keras.Eq_Conditioned.Eq_Expect.Eq_Expect.Eq_Sub.is_finite.to.Eq.Dot.Grad.Expect.A_Function.apply(Eq[0], Eq.Q_Function, Eq[1], Eq.A_Function, Eq[2])

    Eq << Keras.Eq_Conditioned.Eq_Expect.Eq_Expect.Eq_Sub.to.Eq.Expect.temporal_difference_residual.apply(Eq[0], Eq.Q_Function, Eq[1], Eq.A_Function).reversed
