...
def prove(Eq):
    ...
    Eq << Keras.Eq_Clip.Eq_Clip.to.Eq.Softmax.bert.position_representation.relative.apply(Eq.K_quote, Eq.V_quote, Q, K, V)

    Eq << Eq[-1].this.rhs.find(MatMul).apply(Keras.Dot.Softmax.eq.Lamda.Sum.scaled_dot_product_attention, j, k, simplify=1)
