...
def prove(Eq):
    ...
    Eq.ge_neg_min, Eq.lt_min = Sets.In_Range.to.And.apply(Eq[2])

    Eq <<= Eq.ge_neg_min.this.find(Min).args[0].apply(Algebra.Expr.eq.Piece, upper=n - 1), Eq.lt_min.this.find(Add).apply(Algebra.Expr.eq.Piece, upper=n)
