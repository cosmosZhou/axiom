...
import Axiom.Algebra.ValGet.eq.ValSubStrFlatten
import Axiom.Algebra.Get.eq.Default.of.AddMul.ge.Mul
import Axiom.Algebra.Ge.of.NotLt
import Axiom.Algebra.GetSubstr.eq.Get_Add
open Algebra
...
-- proof
  have := ValGet.eq.ValSubStrFlatten v i
