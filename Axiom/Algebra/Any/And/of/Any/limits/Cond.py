...
def apply(given, index=None):
    ...
    if index is None:
        ...
        from Axiom.Algebra.Any.And.of.Any.limits.unleash import limits_cond
...
def prove(Eq):
    ...
    Eq << Algebra.Any.And.of.Any.limits.unleash.apply(Eq[0])

    Eq << Algebra.Any.given.Any.And.limits.unleash.apply(Eq[1])
