...
def prove(Eq):
    ...
    Eq << Discrete.Eq_Dot.to.Eq.Sum.apply(Eq[2], j)
    ...
    Eq << Algebra.Le.to.Le.st.Square.pop.apply(Eq[-1])
    ...
    Eq << Discrete.Eq_Dot.to.Eq.Sum.Square.double_limits.apply(Eq[2])

    Eq << Eq[-2].subs(Eq[-1].reversed)

    Eq << Discrete.Eq_Dot.to.Eq.Sum.Square.offset.apply(Eq[2], y[t], j)
