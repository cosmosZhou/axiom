...
def prove(Eq):
    ...
    Eq << Algebra.Eq_0.Imply.to.Eq_0.induct.apply(Eq.is_zero, Eq.suffice, n=m)
    ...
    Eq << Algebra.Eq_0.Imply.to.Eq_0.induct.apply(Eq.is_zero_even, Eq.suffice_even, n=m)

    Eq << Eq[-1].this.lhs.definition

    Eq.even = Eq[-1].reversed

    Eq << Algebra.Eq.to.All.Eq.Limit_Eq_odd.apply(Eq.odd, m)

    Eq << Algebra.Eq.to.All.Eq.Limit_Eq_even.apply(Eq.even, m)
