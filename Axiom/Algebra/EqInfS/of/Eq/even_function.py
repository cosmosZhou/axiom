...
def prove(Eq):
    ...
    Eq <<= Eq[-4].this.expr.apply(Algebra.Any.of.Any.limits.Neg), Algebra.All.of.All.limits.subs.Neg.real.apply(Eq[-3], x, -x), Algebra.LeInf.given.All_Any_Lt.apply(Eq[-2], z), Algebra.GeInf.given.All.Ge.apply(Eq[-1])
