...
def prove(Eq):
    ...
    Eq << Eq[-1].this.rhs.apply(Algebra.Cond.All.to.All.push)

    Eq << Algebra.Cond.Imply.to.Cond.induct.apply(Eq[0], Eq[-1], n=n, start=1)

    Eq << Algebra.All.to.Or.subs.apply(Eq[-1], k, n - 1)
