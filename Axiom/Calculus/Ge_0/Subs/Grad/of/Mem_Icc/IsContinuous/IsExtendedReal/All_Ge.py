...
def prove(Eq):
    ...
    Eq << Eq[-2].this.expr.apply(Set.Neg.In.IccNegS.of.Mem_Icc, simplify=None)

    Eq << Calculus.Le_0.Subs.Grad.of.Mem_Icc.IsContinuous.IsExtendedReal.All_Le.apply(Eq[0], Eq[-4], Eq[-1], Eq[-2])
