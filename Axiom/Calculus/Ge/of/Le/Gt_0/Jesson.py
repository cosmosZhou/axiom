...
def prove(Eq):
    ...
    Eq.all_is_positive = Algebra.All.of.Cond.apply(Eq[1], x)

    Eq.x0_contains, Eq.x1_contains = Element(x0, domain, plausible=True), Element(x1, domain, plausible=True)

    Eq.x_mean_contains = Set.Mem.Icc.of.Mem.Mem.apply(Eq.x0_contains, Eq.x1_contains, w)

    Eq <<= Calculus.IsDifferentiable.of.Mem.Mem.All_Gt_0.apply(Eq.x0_contains, Eq.x_mean_contains, Eq.all_is_positive), Calculus.IsDifferentiable.of.Mem.Mem.All_Gt_0.apply(Eq.x_mean_contains, Eq.x1_contains, Eq.all_is_positive)
    ...
    Eq.suffice = Eq.any.limits_cond.this.apply(Set.Le.of.Mem.Mem)
    Eq <<= Set.Subset.Icc.of.Mem.Mem.apply(Eq.x0_contains, Eq.x_mean_contains), Set.Subset.Icc.of.Mem.Mem.apply(Eq.x_mean_contains, Eq.x1_contains)
    ...
    Eq <<= Eq[-2].this.rhs.apply(Set.Mem.of.Mem.Subset), Eq[-1].this.rhs.apply(Set.Mem.of.Mem.Subset)
    ...
    Eq << Eq[-1].this.rhs.apply(Calculus.Mem.of.Le.Mem.Mem.All_gt_0)
