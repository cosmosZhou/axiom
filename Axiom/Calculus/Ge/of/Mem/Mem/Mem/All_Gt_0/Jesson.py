...
def prove(Eq):
    ...
    Eq << Algebra.Cond.of.All.subs.apply(Eq[3], x, x_)

    Eq << Calculus.Ge.of.Gt_0.Jesson.apply(Eq[-1], w=w_)

    Eq << Algebra.All.of.Cond.apply(Eq[-1], w_)
    ...
    Eq << Algebra.All.of.Cond.apply(Eq[-1], x0)
    ...
    Eq << Algebra.All.of.Cond.apply(Eq[-1], x1)
