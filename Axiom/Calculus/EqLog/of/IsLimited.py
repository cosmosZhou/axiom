...
@prove(proved=False)
def prove(Eq):
    from Axiom import Calculus, Set, Algebra
    ...
    Eq << Eq[-1].this.expr.expr.apply(Set.Mem.Icc.of.Lt.Gt)

    Eq << Algebra.Any.All.And.of.Cond.Any_All.apply(Eq.A_is_positive, Eq[-1])

    Eq << Eq[-1].this.expr.expr.apply(Set.Mem.Div.of.Gt_0.Mem)
    ...
    Eq << Algebra.Or.of.Cond.subs.apply(Eq[-1], epsilon0, epsilon1 * A)
