...
def prove(Eq):
    ...
    Eq << Eq[2].this.expr.apply(Set.Eq.of.Mem.definition)

    Eq.All_And = Eq[-1].this.expr.apply(Calculus.And.Eq_Grad.of.Eq_Grad)

    Eq << Algebra.And.All.of.All_And.apply(Eq.All_And)
    ...
    Eq <<= Eq[-2].this.expr.apply(Logic.Cond.of.Eq.Cond.subs, reverse=True, simplify=None), Eq[-1].this.expr.apply(Logic.Cond.of.Eq.Cond.subs, reverse=True, simplify=None)
    ...
    Eq << Algebra.Any.And.of.All.Any.apply(*Eq[-2:])
