...
def prove(Eq):
    ...
    Eq << Neuro.EqSoftmax.of.Eq_Max.Eq_Min.Eq.Eq.bert.position_representation.relative.band_part_mask.dilated.apply(Eq.beta, Eq.zeta, Eq[-2], Eq[-1], Q, K, V)
    ...
    Eq <<= Algebra.Eq.of.Eq.Eq.apply(Eq[-6], Eq[-2]), Algebra.Eq.of.Eq.Eq.apply(Eq[-5], Eq[-1])
