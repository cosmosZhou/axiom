...
@prove
def prove(Eq):
    from Axiom import Neuro, Calculus, Probability, Algebra
    ...
    Eq << Neuro.And.Eq.Expect.of.Eq_Conditioned.Eq_Expect.Eq_Expect.Bellman.apply(*Eq[:3])
    ...
    Eq << Eq[-1].this.find(Pr * Sum).apply(Algebra.Mul.eq.Sum)
