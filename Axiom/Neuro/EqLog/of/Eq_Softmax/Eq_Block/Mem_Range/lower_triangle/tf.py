...
def prove(Eq):
    ...
    Eq.ge_relu, Eq.lt_1 = Set.And.of.Mem_Range.apply(Eq[2])
    ...
    Eq << Algebra.Cond.of.Cond.Cond.subs.apply(Eq.ge, Eq.eq, invert=True)

    Eq << Algebra.Cond.of.Cond.Cond.subs.apply(Eq.lt_1, Eq[-1])
