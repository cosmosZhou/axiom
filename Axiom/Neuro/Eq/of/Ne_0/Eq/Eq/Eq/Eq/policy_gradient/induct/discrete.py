...
def prove(Eq):
    ...
    *Eq[-3:], Eq.hypothesis = apply(
    ...
    Eq.recursion = Neuro.EqGrad.of.Eq_Conditioned.Eq_Expect.Eq_Expect.policy_gradient.recursion.discrete.apply(*Eq[:3])
    ...
    Eq << Eq[-1].this.find(Product * Sum[Mul[Pr]]).apply(Algebra.Mul.eq.Sum)
