...
def prove(Eq):
    ...
    Eq.M_def = Eq[0].this.find(Element).apply(Set.Mem_Range.Is.And).this.find(Element).apply(Set.Mem_Range.Is.And)
    ...
    Eq << Algebra.EqLamda.of.Eq.apply(Eq[-1], (j, 0, n[1]), (i, 0, n[0]), (k, 0, m))
