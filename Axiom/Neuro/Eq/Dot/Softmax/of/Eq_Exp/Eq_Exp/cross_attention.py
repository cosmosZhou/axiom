...
@prove
def prove(Eq):
    from Axiom import Neuro, Discrete, Algebra
    ...
    Eq << Neuro.Eq.of.Eq_Block.mask.cross_attention.apply(Eq.ksi_def, a)
    ...
    Eq.lower_part, Eq.upper_part = Algebra.Eq.of.Eq.Eq.apply(Eq[-2], Eq[0][i]), \
        Algebra.Eq.of.Eq.Eq.apply(Eq[-1], Eq[1][i - h])
    ...
    Eq << Eq[-1].this.rhs.apply(Algebra.Lamda.eq.Ite)
