...
@prove
def prove(Eq):
    from Axiom import Neuro, Discrete, Algebra, Logic
    ...
    Eq << Neuro.Eq.of.Eq_Add_Block.mask.cross_attention.apply(Eq.ksi_def, a)
    ...
    Eq << Eq[-1].this.find(ExprCondPair[2]).expr.apply(Algebra.Add.eq.Ite)
    ...
    Eq.divisor_definition = Eq[-1].this.rhs.apply(Algebra.Ite.eq.Add)
    ...
    Eq.lower_part, Eq.upper_part, Eq.diagonal_part = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq[1][i]), \
        Algebra.Eq.of.Eq.Eq.apply(Eq[-3], Eq[2][i - h]), \
        Algebra.Eq.of.Eq.Eq.apply(Eq[-1], Eq.M_definition)
    ...
    Eq << Eq[-1].this.rhs.expr.apply(Algebra.Ite.eq.Add)
    ...
    Eq << Eq[-1].this.find(Lamda).apply(Algebra.Lamda.eq.Ite)
    ...
    Eq << Algebra.EqLamda.of.Eq.apply(Eq[-1], (i,))

    Eq << Eq[-1].this.rhs.apply(Algebra.Lamda.Ite.eq.Block)
