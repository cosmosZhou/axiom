...
def prove(Eq):
    ...
    Eq << Neuro.EqDot.of.Eq_Lamda.position_representation.rotary.apply(Eq[1]).subs(j, k)

    Eq.final = Eq[-2].subs(Eq[-1])

    Eq << Neuro.Dot.eq.Lamda.of.Eq_Lamda.position_representation.rotary.apply(Eq[1], K[k])
