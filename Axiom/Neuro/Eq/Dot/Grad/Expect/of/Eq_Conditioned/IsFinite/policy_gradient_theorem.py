...
def apply(eq, lt):
    ...
    return Equal(γ ** Lamda[t](t) @ Derivative[π](Expectation[r, a:π](r)),
                 γ ** Lamda[t](t) @ Lamda[t](Expectation[r, a:π, s](Derivative[π](log(Pr[a:π](a[t].surrogate | s[t].surrogate))) * (γ ** Lamda[t](t) @ r[t:]))))


@prove
def prove(Eq):
    from Axiom import Calculus, Neuro, Discrete, Probability, Algebra
    ...
    *Eq[-2:], Eq.hypothesis = apply(
    ...
    Eq << Neuro.Eq.Dot.Grad.Expect.of.Eq_Conditioned.Eq_Expect.Eq_Expect.IsFinite.Q_Function.apply(Eq[0], Eq.Q_Function, Eq.V_Function, Eq[-1])
    ...
    Eq << Neuro.Eq.Expect.Grad.Log.Pr.of.Eq_Conditioned.Q_Function.discounted.apply(Eq[0], γ, t, π)
