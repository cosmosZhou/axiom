...
def apply(eq, Q_def, V_def, A_def, lt, π_quote=None):
    ...
    return Equal(γ ** Lamda[t](t) @ Derivative[π](Expectation[r, a:π](r)),
                 γ ** Lamda[t](t) @ Lamda[t](Expectation[a:π_quote, s](Derivative[π](Pr[a:π](a[t].surrogate | s[t].surrogate)) / Pr[a:π_quote](a[t].surrogate | s[t].surrogate) * A_st_var._subs(s[t].var, s[t])._subs(a[t].var, a[t]))))
...
def prove(Eq):
    ...
    *Eq[-5:], Eq.hypothesis = apply(
    ...
    Eq << Neuro.Eq.Dot.Grad.Expect.of.Eq_Conditioned.Eq_Expect.Eq_Expect.Eq_Sub.IsFinite.A_Function.apply(*Eq[:5])
