...
def prove(Eq):
    ...
    Eq << Neuro.EqSoftmax.of.Eq_Clip.Eq_Clip.bert.position_representation.relative.apply(Eq.K_quote, Eq.V_quote, Q, K, V)

    Eq << Eq[-1].this.rhs.find(MatMul).apply(Neuro.Dot.Softmax.eq.Lamda.Sum.scaled_dot_product_attention, j, k, simplify=1)
