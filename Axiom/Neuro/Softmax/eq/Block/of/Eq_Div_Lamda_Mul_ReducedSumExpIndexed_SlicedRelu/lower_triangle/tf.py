...
def prove(Eq):
    ...
    Eq.zij_def = Eq[-1].this.find(Element).apply(Set.Mem.Neg)
    ...
    Eq << Eq[-1].this.find(Element).apply(Set.Mem_Icc.Is.MemSub, i)
    ...
    Eq << Eq[-1].this(i, j).find(And).apply(Set.OrLe.Or.Is.Mem_Range.BandPart.lower.offset)
