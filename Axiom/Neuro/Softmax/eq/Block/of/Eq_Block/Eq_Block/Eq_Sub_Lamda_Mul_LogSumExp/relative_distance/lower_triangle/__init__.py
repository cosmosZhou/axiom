...
def prove(Eq):
    ...
    Eq << Neuro.All.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.upper_part.apply(Eq[0], Eq[1])

    Eq << Algebra.EqLamda.of.All_Eq.apply(Eq[-1].this.expr.reversed, Eq[2].find(Lamda).expr)

    Eq << Neuro.All.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.lower_part.apply(Eq[0], Eq[1])
