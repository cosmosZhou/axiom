...
def prove(Eq):
    ...
    Eq << Neuro.All.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.upper_part.tf.apply(Eq[1], Eq[2])

    Eq << Algebra.EqLamda.of.All_Eq.apply(Eq[-1].this.expr.reversed, Eq[3].find(Lamda).expr)

    Eq << Neuro.All.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.lower_part.tf.apply(Eq[1], Eq[2])

    Eq << Algebra.EqLamda.of.All_Eq.apply(Eq[-1].this.expr.reversed)

    Eq << Neuro.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.apply(Eq[1], Eq[2])
