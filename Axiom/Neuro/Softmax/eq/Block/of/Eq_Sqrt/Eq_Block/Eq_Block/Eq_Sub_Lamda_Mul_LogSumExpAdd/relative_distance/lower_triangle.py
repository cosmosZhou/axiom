...
def prove(Eq):
    ...
    Eq << Neuro.All.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.upper_part.apply(Eq[1], Eq[2])

    Eq << Algebra.EqLamda.of.All_Eq.apply(Eq[-1].this.expr.reversed, Eq[3].find(Lamda).expr)

    Eq << Neuro.All.Eq.of.Eq_Block.Eq_Block.relative_distance.lower_triangle.lower_part.apply(Eq[1], Eq[2])
    ...
    Eq << Eq[-1].this.find(-~Min).apply(Neuro.Min.eq.Add.Relu)
