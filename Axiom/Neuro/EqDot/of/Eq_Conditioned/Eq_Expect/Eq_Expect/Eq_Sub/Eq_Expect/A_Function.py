...
@prove
def prove(Eq):
    from Axiom import Algebra, Probability, Neuro
    ...
    *Eq[-5:], Eq.hypothesis = apply(
    ...
    Eq << Eq.hypothesis.this.rhs.find(Expectation).apply(Algebra.Expr.eq.Lamda, t)
    ...
    Eq << Neuro.EqDot.of.Eq_Conditioned.Eq_Expect.Eq_Expect.Eq_Sub.A_Function.apply(*Eq[:4], π_quote)
