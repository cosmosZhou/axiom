...
def prove(Eq):
    ...
    Eq << Neuro.EqExpect.of.Eq_Expect.V_Function.normalized.apply(Eq[1])

    Eq << Algebra.Eq.of.Eq.Eq.apply(Eq[2], Eq[-1])

    Eq << Probability.EqConditioned.of.Eq_Conditioned.getitem.apply(Eq[0], 1)

    Eq << Neuro.EqExpect.of.Eq_Conditioned.Bellman.V_Function.normalized.apply(Eq[-1], γ, t)
    ...
    Eq << Neuro.EqExpect.of.Eq_Conditioned.Bellman.Q_Function.normalized.apply(Eq[0], γ, t)
