...
def prove(Eq):
    ...
    Eq << Eq[0].lhs.this.apply(Neuro.Dot.Softmax.eq.Lamda.Dot.scaled_dot_product_attention.double_limits, i, j)

    Eq << Eq[-1].this.rhs.find(MatMul).apply(Discrete.Dot.eq.Sum, simplify=1)
