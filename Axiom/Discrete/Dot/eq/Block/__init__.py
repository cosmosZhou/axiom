...
def prove(Eq):
    ...
    Eq << Eq[-1].lhs.this.apply(Discrete.Dot.eq.Block.basic)

    Eq << Eq[-1].this.rhs.find(MatMul).apply(Discrete.Dot.eq.Block.basic)

    Eq << Eq[-1].this.rhs.find(MatMul).apply(Discrete.Dot.eq.Block.basic)

    Eq << Eq[-1].this.rhs.find(MatMul).apply(Discrete.Dot.eq.Block.basic)

    Eq << Eq[-1].this.rhs.find(MatMul[BlockMatrix]).apply(Discrete.Dot.eq.Block.basic)
