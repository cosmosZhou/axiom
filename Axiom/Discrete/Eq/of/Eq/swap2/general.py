...
def prove(Eq):
    ...
    Eq << Algebra.EqLamda.of.Eq.apply(Eq[-1], (i, 0, n), simplify=False)
    ...
    Eq << Algebra.All.And.of.All.All.apply(Eq[-2], Eq[-3])

    Eq << Discrete.All_Mem.of.Eq.All_Mem.swap2.apply(Eq[1], Eq[-1])
