...
def prove(Eq):
    ...
    Eq.back_subs0 = Discrete.EqInv.of.Eq_Dot.apply(Eq[-1], left=True)

    Eq.back_subs0 = Algebra.Eq.of.Eq.Eq.apply(Eq[0], Eq.back_subs0)
    ...
    Eq.back_subs1 = Discrete.EqInv.of.Eq_Dot.apply(Eq[-1], left=True)

    Eq.back_subs1 = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq.back_subs1)

    Eq.back_subs1 = Discrete.EqInv.of.Eq_Dot.apply(Eq.back_subs1, left=True)
    ...
    Eq.back_subs2 = Discrete.EqInv.of.Eq_Dot.apply(Eq[-1], left=True)

    Eq.back_subs2 = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq.back_subs2)

    Eq.back_subs2 = Discrete.EqInv.of.Eq_Dot.apply(Eq.back_subs2, left=True)
    ...
    Eq.back_subs3 = Discrete.EqInv.of.Eq_Dot.apply(Eq[-1], left=True)

    Eq.back_subs3 = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq.back_subs3)

    Eq.back_subs3 = Discrete.EqInv.of.Eq_Dot.apply(Eq.back_subs3, left=True)
    ...
    Eq.back_subs4 = Discrete.EqInv.of.Eq_Dot.apply(Eq[-1], left=True)

    Eq.back_subs4 = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq.back_subs4)

    Eq.back_subs4 = Discrete.EqInv.of.Eq_Dot.apply(Eq.back_subs4, left=True)
    ...
    Eq.back_subs5 = Discrete.EqInv.of.Eq_Dot.apply(Eq[-1], left=True)

    Eq.back_subs5 = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq.back_subs5)

    Eq.back_subs5 = Discrete.EqInv.of.Eq_Dot.apply(Eq.back_subs5, left=True)
    ...
    Eq.back_subs6 = Algebra.Eq.of.Eq.Eq.apply(Eq[-4], Eq.back_subs6)

    Eq.back_subs6 = Discrete.EqInv.of.Eq_Dot.apply(Eq.back_subs6, left=True)
