...
def prove(Eq):
    ...
    Eq << Discrete.DetBlock_Lamda_Pow.eq.Mul_Prod_Factorial.vandermonde.apply(Det(BlockMatrix([Lamda[j:n + 1](r ** j), Lamda[j:n + 1, i:n](j ** i)])))
    ...
    Eq << Eq[-1].this.find(Element).apply(Set.Mem_Icc.Is.MemSub, 1)
