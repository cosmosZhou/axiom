...
def prove(Eq):
    ...
    Eq << Set.Subset.Finset.of.Mem.Mem.apply(Eq[-1], Eq[-2], simplify=None)

    Eq << Set.Subset.of.Mem.Subset.apply(Eq[0], Eq[-1], simplify=None)

    Eq << Set.Mem.Ite.of.Subset.apply(Eq[-1], piecewise=Eq.element_piecewise.lhs)
