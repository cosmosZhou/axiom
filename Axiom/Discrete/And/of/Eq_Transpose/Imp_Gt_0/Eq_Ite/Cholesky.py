...
def apply(eq, infer, eq_piece):
    from Axiom.Discrete.All.And.of.Eq_Transpose.Imp_Gt_0.Eq_Ite.Cholesky import extract
...
def prove(Eq):
    ...
    Eq <<= Algebra.And.All.of.All_And.apply(Eq[-1]), Set.Mem_Union.of.Mem.apply(Eq[-2], Reals)
    ...
    Eq << Eq[-1].this.rhs.apply(Set.Mem_Union.of.Mem, Reals)
