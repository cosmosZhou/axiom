...
def prove(Eq):
    ...
    Eq << Eq[-1].this.find(BlockMatrix[1]).apply(Algebra.Block.eq.Lamda.Ite)
    ...
    Eq << Eq[-1].this.find(Det[2]).apply(Discrete.DetDotLamdaS.eq.Mul_Prod.vandermonde.col_transform)
