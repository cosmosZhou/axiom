...
jush.api.php = {
	...
	dbx_connect: 'Open a connection/database (mixed module, string host, string database, string user, string password, [int persistent]): object',
	...
	fbsql_connect: 'Open a connection to a FrontBase Server ([string hostname, [string user, [string password]]]): resource',
	...
	fbsql_pconnect: 'Open a persistent connection to a FrontBase Server ([string hostname, [string user, [string password]]]): resource',
	...
	fbsql_username: 'Get or set the user for the connection (resource link_identifier, [string user]): string',
	...
	ftp_login: 'Logs in to an FTP connection (resource ftp_stream, string user, string password): bool',
	...
	hw_connect: 'Opens a connection (string host, int port, [string user], string password): int',
	...
	hw_identify: 'Identifies as user (int link, string user, string password): string',
	...
	hw_pconnect: 'Make a persistent database connection (string host, int port, [string user], string password): int',
	...
	ibase_connect: 'Open a connection to an InterBase database ([string database, [string user, [string password, [string charset, [int buffers, [int dialect, [string role, [int sync]]]]]]]]): resource',
	...
	ibase_pconnect: 'Open a persistent connection to an InterBase database ([string database, [string user, [string password, [string charset, [int buffers, [int dialect, [string role, [int sync]]]]]]]]): resource',
	...
	db2_connect: 'Returns a connection to a database (string database, string user, string password, [array options]): resource',
	...
	db2_pconnect: 'Returns a persistent connection to a database (string database, string user, string password, [array options]): resource',
	...
	imap_open: 'Open an IMAP stream to a mailbox (string mailbox, string user, string password, [int options, [int n_retries, [array params]]]): resource',
	...
	ingres_connect: 'Open a connection to an Ingres database ([string database, [string user, [string password, [array options]]]]): resource',
	...
	ingres_pconnect: 'Open a persistent connection to an Ingres database ([string database, [string user, [string password, [array options]]]]): resource',
	...
	maxdb_connect: 'Open a new connection to the MaxDB server ([string host, [string user, [string passwd, [string dbname, [int port, [string socket]]]]]]): resource',
	...
	maxdb_real_connect: 'Opens a connection to a MaxDB server (resource link, [string hostname, [string user, [string passwd, [string dbname, [int port, [string socket]]]]]]): bool',
	...
	mssql_connect: 'Open MS SQL server connection ([string servername, [string user, [string password, [bool new_link]]]]): resource',
	...
	mssql_pconnect: 'Open persistent MS SQL connection ([string servername, [string user, [string password, [bool new_link]]]]): resource',
	...
	mysql_connect: 'Open a connection to a MySQL Server ([string server, [string user, [string password, [bool new_link, [int client_flags]]]]]): resource',
	...
	mysql_pconnect: 'Open a persistent connection to a MySQL server ([string server, [string user, [string password, [int client_flags]]]]): resource',
	mysql_pconnect: 'Open a persistent connection to a MySQL server ([string server, [string user, [string password, [bool new_link, [int client_flags]]]]]): resource',
	...
	mysqli_connect: 'Open a new connection to the MySQL server ([string host, [string user, [string passwd, [string dbname, [int port, [string socket]]]]]]): mysqli',
	...
	mysqli_real_connect: 'Opens a connection to a mysql server (mysqli link, [string host, [string user, [string passwd, [string dbname, [int port, [string socket, [int flags]]]]]]]): bool',
	...
	oci_connect: 'Connect to an Oracle database (string user, string password, [string connection_string, [string character_set, [int session_mode]]]): resource',
	...
	oci_new_connect: 'Connect to the Oracle server using a unique connection (string user, string password, [string connection_string, [string character_set, [int session_mode]]]): resource',
	...
	oci_password_change: 'Changes password of Oracle\'s user (resource connection, string user, string old_password, string new_password): bool',
	oci_password_change: 'Changes password of Oracle\'s user (string dbname, string user, string old_password, string new_password): resource',
	oci_pconnect: 'Connect to an Oracle database using a persistent connection (string user, string password, [string connection_string, [string character_set, [int session_mode]]]): resource',
	...
	pdf_create_3dview: 'Create 3D view (resource pdfdoc, string user, string optlist): int',
	...
	posix_getpwnam: 'Return info about a user by user (string user): array',
	...
	ssh2_auth_hostbased_file: 'Authenticate using a public hostkey (resource session, string user, string hostname, string pubkeyfile, string privkeyfile, [string passphrase, [string local_username]]): bool',
	ssh2_auth_none: 'Authenticate as "none" (resource session, string user): mixed',
	ssh2_auth_password: 'Authenticate over SSH using a plain password (resource session, string user, string password): bool',
	ssh2_auth_pubkey_file: 'Authenticate using a public key (resource session, string user, string pubkeyfile, string privkeyfile, [string passphrase]): bool',
	...
	stomp_connect: 'Opens a connection ([string broker, [string user, [string password]]]): resource',
	...
	sybase_connect: 'Opens a Sybase server connection ([string servername, [string user, [string password, [string charset, [string appname, [bool new]]]]]]): resource',
	...
	sybase_pconnect: 'Open persistent Sybase connection ([string servername, [string user, [string password, [string charset, [string appname]]]]]): resource',
	...
	vpopmail_auth_user: 'Attempt to validate a user/domain/password (string user, string domain, string password, [string apop]): bool',
...
jush.api.php_new = {
	...
	maxdb: 'Open a new connection to the MaxDB server ([string host, [string user, [string passwd, [string dbname, [int port, [string socket]]]]]])',
	...
	mysqli: 'Open a new connection to the MySQL server ([string host, [string user, [string passwd, [string dbname, [int port, [string socket]]]]]])',
	oauth: 'Create a new OAuth object (string consumer_key, string consumer_secret, [string signature_method, [string auth_type]])',
	pdo: 'Creates a PDO instance representing a connection to a database (string dsn, [string user, [string password, [array driver_options]]])',
