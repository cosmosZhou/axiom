...
echo sed -i -E "s/(namespace|end|open) $src_namespace/\1 $dst_namespace/g" $dstFile
sed -i -E "s/(namespace|end|open) $src_namespace/\1 $dst_namespace/g" $dstFile
...
echo sed -i "s/^theorem $src_theorem/theorem $dst_theorem/" $dstFile
sed -i "s/^theorem $src_theorem/theorem $dst_theorem/" $dstFile
